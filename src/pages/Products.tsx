...
const Products = () => {
  const products = [
    ...
    {
      name: 'Mixed Blended Oil',
      description: 'Carefully crafted blend of multiple oils for optimal nutrition and cooking performance. Perfect balance of taste, health, and versatility.',
      image: 'blended-oil',
      price: '₹170/L',
      features: ['Multi-Oil Blend', 'Balanced Nutrition', 'Versatile Cooking', 'Cost Effective', 'Enhanced Taste'],
      benefits: ['Complete Nutrition', 'Better Absorption', 'Economical Choice'],
